                ...
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list dropdown d-none d-lg-inline-block ml-2">
                        <a class="nav-link dropdown-toggle mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="assets/imagenes/espanol.png" alt="lang-image" height="12">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="./assets/imagenes/espanol.png" alt="lang-image" class="mr-1" height="12"> <span
                                    class="align-middle">Español</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="./assets/imagenes/ingles.jpg" alt="lang-image" class="mr-1" height="12"> <span
                                    class="align-middle">Ingles</span>
                            </a>
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="./assets/imagenes/usuario.avif" alt="user-image" class="rounded-circle">
                            <span class="d-none d-sm-inline-block ml-1 font-weight-medium">Alex T.</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                ...
                                <span><a href="?c=dashboard&m=dashboard">Cerrar sesión</a></span>
                            </a>
